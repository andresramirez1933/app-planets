...
const loadPlanet = async function(planet) {
    try {
        if ((0, _helpersJs.isSolarSystemPlanet)(planet)) state.planet = getPlanetInfo(planet);
        else {
            state.planet = await loadExoplanet(planet);
            state.image = getExoplanetImage(classifyExoplanet(state.planet));
            console.log(state);
        }
    } catch (err) {
        console.error(err);
...
function classifyExoplanet(data) {
    ...
    // Rp is radius in R_Jupiter
    const Rp = data.Rp; // Jupiter radii
    const Tp = data.Tp; // Temperature (optional)
    if (!Rp) return 'unknown';
    // Convert to Earth radii
    const radiusEarth = Rp * 11.2;
...
},{"./helpers.js":"7nL9P","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./model/planetsModel.js":"cgtgU","./model/exoplanetNameMap.js":"4HgPr","./model/exoplanetsModel.js":"hsBNA"}],"7nL9P":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4HgPr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const EXOPLANET_IMAGES = {
    gas_giant: [
        '/img/exoplanets/gasgiant_1.jpg',
        '/img/exoplanets/gasgiant_2.jpg',
        '/img/exoplanets/hkjupiter_1.jpg'
    ],
    mini_neptune: [
        '/img/exoplanets/minineptune.jpg'
    ],
    earthlike: [
        '/img/exoplanets/earthlike_1.jpg',
        '/img/exoplanets/earthlike_2.jpg'
    ],
    rocky: [
        '/img/exoplanets/rocky_1.jpg',
        '/img/exoplanets/rocky_2.jpg'
    ],
    unknown: [
        '/img/exoplanets/earthlike_1.jpg'
    ]
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["lkFLC","3QBkH"], "3QBkH", "parcelRequirec302", {})

//# sourceMappingURL=App Planets.a7ee6ca6.js.map
